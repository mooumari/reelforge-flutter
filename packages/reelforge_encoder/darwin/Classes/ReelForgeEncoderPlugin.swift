...
public class ReelForgeEncoderPlugin: NSObject, FlutterPlugin {
  ...
  private let audioQueue = DispatchQueue(
    label: "reelforge.encoder.audio", qos: .userInitiated)
  ...
  private let queue = DispatchQueue(label: "reelforge.encoder", qos: .userInitiated)
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let channel = FlutterMethodChannel(
      name: "reelforge/encoder", binaryMessenger: messenger)
    registrar.addMethodCallDelegate(ReelForgeEncoderPlugin(), channel: channel)
    ...
    ReelForgeDecoderPlugin.register(with: registrar)
  }
