...
class ReelForgeEncoderPlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
  private lateinit var channel: MethodChannel
  private var decoder: ReelForgeDecoderPlugin? = null
  ...
  override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(binding.binaryMessenger, "reelforge/encoder")
    ...
    decoder = ReelForgeDecoderPlugin().also { it.attach(binding.binaryMessenger) }
  }
