...
class FluttermotionDecoderPlugin : MethodChannel.MethodCallHandler {
  ...
  fun attach(messenger: BinaryMessenger) {
    channel = MethodChannel(messenger, "fluttermotion/decoder").also {
...
class DecodeSource(
  ...
  init {
    ...
    val track = FluttermotionDecoderPlugin.videoTrackOf(extractor)
    val format = extractor.getTrackFormat(track)
