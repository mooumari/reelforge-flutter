...
class ReelForgePreview extends StatefulWidget {
  const ReelForgePreview({
    super.key,
  ...
  @override
  State<ReelForgePreview> createState() => _ReelForgePreviewState();
}

class _ReelForgePreviewState extends State<ReelForgePreview> {
  int _selected = 0;
