...
import 'package:reelforge_cli/src/document_entry.dart';
import 'package:reelforge_cli/src/host.dart';
import 'package:reelforge_cli/src/init_command.dart';
import 'package:reelforge_cli/src/inspect_command.dart';
import 'package:reelforge_cli/src/preview_command.dart';
import 'package:reelforge_cli/src/render_command.dart';
import 'package:reelforge_cli/src/validate_command.dart';

const String _usage = '''
ReelForge — render Flutter compositions to video.

Usage:
  reelforge init     [options]
  reelforge preview  [<document.json>] [options]
  reelforge render   [<document.json>] [options]
  reelforge validate <document.json>
  reelforge inspect  [options]
  reelforge list     [<document.json>] [options]
...
init options:
  ...
  --reelforge <p>   Path to the reelforge package
