...
/// Render host. The ReelForge CLI builds this entry point and drives it;
...
/// Preview app. Run it with `reelforge preview`, then scrub.
///
...
/// ```
///
/// If your app has the `reelforge_encoder` plugin, passing it here adds an
