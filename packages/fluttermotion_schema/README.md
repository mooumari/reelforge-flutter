# fluttermotion_schema

The FlutterMotion document format: parsing, validation, and the node
...
`fluttermotion_json/test/vocabulary_test.dart` fails if any name set here has
