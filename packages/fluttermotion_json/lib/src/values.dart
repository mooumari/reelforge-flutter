...
Color _role(MotionPalette palette, String name) => switch (name) {
...
void checkAnimated(Object? value, String path, Problems problems) {
  ...
  if (value.containsKey('keyframes')) {
    ...
    reader.oneOf('ease', namedCurves.keys.toSet());
...
void _checkBindingString(String value, String path, Problems problems) {
  if (!isBinding(value)) {
    problems.add(
      path,
      '"$value" is neither a number nor a "{{ }}" binding',
    );
    return;
  }
...
void checkColour(Object? value, String path, Problems problems) {
  ...
  if (_parseHex(value) != null) return;
  problems.add(
    path,
...
double? resolveOptionalNumber(BuildContext context, Object? spec,
        {DataScope? scope}) =>
    spec == null ? null : resolveNumber(context, spec, scope: scope);

int? resolveOptionalInt(BuildContext context, Object? spec,
        {DataScope? scope}) =>
...
String? resolveOptionalString(BuildContext context, Object? spec,
        {DataScope? scope}) =>
...
Color? resolveColour(BuildContext context, Object? spec, {DataScope? scope}) {
  ...
  if (paletteRoles.contains(value)) {
    return _role(MotionTheme.paletteOf(context), value);
  }
  final int? hex = _parseHex(value);
